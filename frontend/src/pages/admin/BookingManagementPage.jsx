      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-500">
            Tra cứu đơn đặt phòng toàn hệ thống.
          </p>
        </div>
        <input
          type="text"
            ...
            {bookings
              ...
              .map((b) => (
                <tr key={b.id}>
                  ...
                  <td className="p-4">
                    <span
                      className={`px-2.5 py-1 text-xs font-bold rounded-full ${b.status === "confirmed" ? "bg-blue-100 text-blue-700" : "bg-amber-100 text-amber-700"}`}
                    >
                      {b.status}
                    </span>
                  </td>
