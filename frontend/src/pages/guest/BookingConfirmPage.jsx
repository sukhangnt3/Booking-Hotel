              ...
              <div className="p-3.5 bg-blue-50/70 rounded-2xl border border-blue-200 text-xs space-y-2">
                ...
                <div className="space-y-1 text-slate-700">
                  ...
                  <p>
                    ...
                    <strong>
                      {checkOutTime}{" "}
                      {safeFormatDate(checkOutDate, "dd 'Thg' MM, yyyy")}
                    </strong>
                  </p>
                  <p>
                    ⏳ Thời gian lưu trú:{" "}
                    <strong className="text-[#006ce4]">{durationLabel}</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm space-y-4">
              ...
              <div className="space-y-2.5 text-xs">
                <div className="flex justify-between text-gray-700">
                  <span>Đơn giá ({durationLabel}):</span>
                  <span>
                    {formatVND(
                      rentalType === "HOUR"
                        ? hourlyUnitPrice
