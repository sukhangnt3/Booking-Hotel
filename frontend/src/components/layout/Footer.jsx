        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-12 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="bg-gradient-to-br from-amber-400 via-amber-500 to-amber-600 text-[#0a2540] p-2 rounded-xl shadow-md shrink-0"></div>
            ...
            <p className="text-xs leading-relaxed text-slate-400 font-normal">
              Nền tảng đặt phòng nghỉ dưỡng, resort cao cấp và homestay phong
              cách hàng đầu Việt Nam với mức giá đặc quyền.
            </p>
          ...
          <div className="space-y-4 lg:pl-6">
            ...
            <ul className="space-y-2.5 text-xs text-slate-400">
              <li>
                <a
                  href="#"
                  className="hover:text-amber-300 hover:translate-x-1 inline-block transition-all"
                >
                  Về chúng tôi
                </a>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              ...
              <div className="flex flex-wrap items-center gap-2 text-[11px] font-extrabold text-slate-300">
                <span className="px-2.5 py-1 rounded-lg bg-white/5 border border-slate-700">
                  VNPay QR
                </span>
              </div>
            </div>
